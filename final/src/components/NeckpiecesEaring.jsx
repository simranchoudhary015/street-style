    ...
    const fetchProducts = async () => {
      try {
        const response = await axios.get(
          "https://street-style-shop-server.onrender.com/api/product/fetchproducts?category=neckpiecesEaring"
        );
...
export default NeckpiecesEaring;
